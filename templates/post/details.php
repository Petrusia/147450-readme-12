        ...
        <div class="post-details__wrapper post-<?= $post['type'] ?>">
            <div class="post-details__main-block post post--details">
                ...
                <div class="post__indicators">
                    ...
                    <span class="post__view"><?= getViewsOfPublication($post['views_number']) ?></span>
                </div>
                <ul class="post__tags">
                    ...
                    <div class="comments__list-wrapper">
                                        ...
                                        <div class="comments__info">
                                            <div class="comments__name-wrapper">
                                                ...
                                                <time class="comments__time"
                                                      datetime="<?= $comment['comment_date'] ?>"><?= getDateDiff(
                        ...
                        if (is_array($comments)) : ?>
                            ...
                            <a class="comments__more-link" href="#">
                                ...
                                <sup class="comments__amount"><?= $numberOfComments ?></sup>
                            </a>
                        <?php
                        endif; ?>
                        <?php
            ...
            <div class="post-details__user user">
                <div class="post-details__user-info user__info">
                    ...
                    <div class="post-details__name-wrapper user__name-wrapper">
                        ...
                        <time class="post-details__time user__time" datetime="2014-03-20"><?= getDateDiff(
                                $post['registered_at']
                            ) ?></time>
                    </div>
                </div>
                <div class="post-details__rating user__rating">
                    <p class="post-details__rating-item user__rating-item user__rating-item--subscribers">
                        <span class="post-details__rating-amount user__rating-amount"><?= $numberOfSubscribers ?></span>
                        <span class="post-details__rating-text user__rating-text"><?= $textOfSubscribers ?></span>
                    </p>
                    <p class="post-details__rating-item user__rating-item user__rating-item--publications">
                        <span
                            class="post-details__rating-amount user__rating-amount"><?= $numberOfPublications ?></span>
                        <span class="post-details__rating-text user__rating-text"><?= $textOfPublications ?></span>
                    </p>
                </div>
